...
@section('title', 'Удаление бана пользователя '.$ban->user_to->getFullName())
...
@section('page_title', 'Удаление бана пользователя '.$ban->user_to->getFullName())
...
@section('content')
    ...
    <form method="POST" class="form_main">
        ...
        <div class="errors">
            <p>
                Вы действительно хотите удалить этот бан?
            </p>
        </div>
